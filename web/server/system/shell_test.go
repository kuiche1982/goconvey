...
func TestShellCommandComposition(t *testing.T) {
	var (
		...
		goConvey         = Command{Output: "[fmt github.com/kuiche1982/goconvey/convey net/http net/http/httptest path runtime strconv strings testing time]"}
