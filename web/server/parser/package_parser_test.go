...
const input_NoGoFiles = `can't load package: package github.com/kuiche1982/goconvey: no buildable Go source files in /Users/matt/Work/Dev/goconvey/src/github.com/kuiche1982/goconvey`

var expected_NoGoFiles = contract.PackageResult{
	PackageName: "github.com/kuiche1982/goconvey",
...
var expected_BuildFailed_InvalidPackageDeclaration = contract.PackageResult{
	PackageName: "github.com/kuiche1982/goconvey/examples",
...
FAIL	github.com/kuiche1982/goconvey/examples [setup failed]
`
...
# github.com/kuiche1982/goconvey/examples
...
FAIL	github.com/kuiche1982/goconvey/examples [build failed]
`
...
# github.com/kuiche1982/goconvey/t
./t_test.go:23: import "github.com/kuiche1982/goconvey/t" while compiling that package (import cycle)
FAIL	github.com/kuiche1982/goconvey/t [build failed]
`

var expected_BuildFailed_ImportCycle = contract.PackageResult{
	PackageName: "github.com/kuiche1982/goconvey/t",
	Outcome:     contract.BuildFailure,
...
--- PASS: TestOldSchool_PassesWithMessage (0.05 seconds)
	old_school_test.go:10: I am a passing test.
		With a newline.
PASS
coverage: 100.0%% of statements in github.com/kuiche1982/goconvey/convey, github.com/kuiche1982/goconvey/convey/gotest, github.com/kuiche1982/goconvey/convey/reporting
ok  	github.com/kuiche1982/goconvey/webserver/examples	0.018s
`

var expectedOldSchool_Passes = contract.PackageResult{
	PackageName: "github.com/kuiche1982/goconvey/webserver/examples",
	Elapsed:     0.018,
	Coverage:    100,
...
FAIL
exit status 1
FAIL	github.com/kuiche1982/goconvey/webserver/examples	0.017s
`
...
exit status 1
FAIL	github.com/kuiche1982/goconvey/webserver/examples	0.414s
`
...
github.com/kuiche1982/goconvey/webserver/examples.TestOldSchool_Panics(0x210292000)
	/Users/mike/work/dev/goconvey/src/github.com/kuiche1982/goconvey/webserver/examples/something_test.go:15 +0xec
...
main.main()
	github.com/kuiche1982/goconvey/webserver/examples/_test/_testmain.go:43 +0x9a
exit status 2
FAIL	github.com/kuiche1982/goconvey/webserver/examples	0.014s
`
...
var expectedOldSchool_Panics = contract.PackageResult{
	...
	TestResults: []contract.TestResult{
		contract.TestResult{
			...
			Elapsed:  0.02,
			Passed:   false,
			File:     "/Users/mike/work/dev/goconvey/src/github.com/kuiche1982/goconvey/webserver/examples/something_test.go",
			Line:     15,
			Message:  "",
...
testing.Main(0x138f38, 0x1b09f0, 0x1, 0x1, 0x1b7f60, ...)
	/usr/local/go/src/pkg/testing/testing.go:365 +0x8a
main.main()
	github.com/kuiche1982/goconvey/webserver/examples/_test/_testmain.go:43 +0x9a`, "\u0009", "\t", -1),
			Stories: []reporting.ScopeResult{},
		},
	},
}
...
>->->OPEN-JSON->->->
{
  ...
  "File": "/Users/mike/work/dev/goconvey/src/github.com/kuiche1982/goconvey/webserver/examples/old_school_test.go",
  "Line": 11,
  "Depth": 0,
  "Assertions": [
    {
      ...
      "Error": null,
      "Skipped": false,
      "StackTrace": "goroutine 3 [running]:\ngithub.com/kuiche1982/goconvey/webserver/examples.func·001()\n\u0009/Users/mike/work/dev/goconvey/src/github.com/kuiche1982/goconvey/webserver/examples/old_school_test.go:10 +0xe3\ngithub.com/kuiche1982/goconvey/webserver/examples.TestPassingStory(0x210314000)\n\u0009/Users/mike/work/dev/goconvey/src/github.com/kuiche1982/goconvey/webserver/examples/old_school_test.go:11 +0xec\ntesting.tRunner(0x210314000, 0x21ab10)\n\u0009/usr/local/go/src/pkg/testing/testing.go:353 +0x8a\ncreated by testing.RunTests\n\u0009/usr/local/go/src/pkg/testing/testing.go:433 +0x86b\n"
    }
  ]
},
<-<-<-CLOSE-JSON<-<-<
...
PASS
ok  	github.com/kuiche1982/goconvey/webserver/examples	0.019s
`
...
{
  "Title": "A passing story",
  "File": "/Users/mike/work/dev/goconvey/src/github.com/kuiche1982/goconvey/web/server/testing/go_test.go",
  "Line": 16,
  "Depth": 0,
  "Assertions": [
    {
      ...
      "Error": null,
      "Skipped": false,
      "StackTrace": "goroutine 3 [running]:\ngithub.com/kuiche1982/goconvey/web/server/testing.func·001()\n\u0009/Users/mike/work/dev/goconvey/src/github.com/kuiche1982/goconvey/web/server/testing/go_test.go:14 +0x186\ngithub.com/kuiche1982/goconvey/web/server/testing.TestPassingStory(0x210315000)\n\u0009/Users/mike/work/dev/goconvey/src/github.com/kuiche1982/goconvey/web/server/testing/go_test.go:16 +0x1b9\ntesting.tRunner(0x210315000, 0x21bb10)\n\u0009/usr/local/go/src/pkg/testing/testing.go:353 +0x8a\ncreated by testing.RunTests\n\u0009/usr/local/go/src/pkg/testing/testing.go:433 +0x86b\n"
    }
  ]
},
<-<-<-CLOSE-JSON<-<-<
  ...
  "Assertions": [
    {
      ...
      "Error": null,
      "Skipped": false,
      "StackTrace": "goroutine 3 [running]:\ngithub.com/kuiche1982/goconvey/web/server/testing.func·002()\n\u0009/Users/mike/work/dev/goconvey/src/github.com/kuiche1982/goconvey/web/server/testing/go_test.go:20 +0x186\ngithub.com/kuiche1982/goconvey/web/server/testing.TestPassingStory(0x210315000)\n\u0009/Users/mike/work/dev/goconvey/src/github.com/kuiche1982/goconvey/web/server/testing/go_test.go:22 +0x294\ntesting.tRunner(0x210315000, 0x21bb10)\n\u0009/usr/local/go/src/pkg/testing/testing.go:353 +0x8a\ncreated by testing.RunTests\n\u0009/usr/local/go/src/pkg/testing/testing.go:433 +0x86b\n"
    }
  ]
},
<-<-<-CLOSE-JSON<-<-<
...
ok  	github.com/kuiche1982/goconvey/web/server/testing	0.024s
`

var expectedGoConvey_WithRandomOutput = contract.PackageResult{
	PackageName: "github.com/kuiche1982/goconvey/web/server/testing",
	Elapsed:     0.024,
	Outcome:     contract.Passed,
	Coverage:    45.0,
	TestResults: []contract.TestResult{
...
FAIL
exit status 1
FAIL	github.com/kuiche1982/goconvey/webserver/examples	0.018s
`
...
FAIL
exit status 1
FAIL	github.com/kuiche1982/goconvey/webserver/examples	0.18s
`
...
--- PASS: Golang15 (0.01s)
PASS
ok  	github.com/kuiche1982/goconvey/webserver/examples	0.008s
`
...
FAIL
exit status 1
FAIL	github.com/kuiche1982/goconvey/webserver/examples	0.007s
`
...
PASS
ok  	github.com/kuiche1982/goconvey/webserver/examples	3.433s
`
...
/Users/joeuser/go/src/github.com/kuiche1982/goconvey/webserver/examples/main.go:141

Ran 33 of 33 Specs in 0.005 seconds
FAIL! -- 32 Passed | 1 Failed | 0 Pending | 0 Skipped --- FAIL: TestRoutes (0.01s)
FAIL
FAIL	github.com/kuiche1982/goconvey/webserver/examples	0.810s
`
